            ...
            (function(e) {
                    ...
                    h._config = {
                        ...
                        h._getInstallationId = function() {
                            if (h._installationId)
                                return l.resolve(h._installationId);
                            var t = h._getAVPath("installationId");
                            return h.localStorage.getItemAsync(t).then(function(e) {
                                return h._installationId = e,
                                    h._installationId ? e : (h._installationId = e = i(),
                        ...
                        h._encode = function(t, e, n) {
                            ...
                            if (r.isRegExp(t))
                                return t.source;
                            if (t instanceof h.Relation)
                                return t.toJSON();
                            if (t instanceof h.Op)
                                return t.toJSON();
                        ...
                        h._decode = function(t, e) {
                            ...
                            if ("Object" === t.__type) {
                                ...
                                return a._finishFetch(o, !0),
                                    a
                            }
                            if ("Date" === t.__type)
                                return h._parseDate(t.iso);
        ...
        , function(t, e, n) {
            ...
            m.serializeObject = i,
                ...
                c.prototype._parseBody = function(t) {
                    ...
                    return this.req._parser ? this.req._parser(this, t) : (!e && u(this.type) && (e = m.parse["application/json"]),
                ...
                l.prototype.type = function(t) {
                    return this.set("Content-Type", m.types[t] || t),
                        this
                }
                ,
                l.prototype.accept = function(t) {
                    return this.set("Accept", m.types[t] || t),
                        this
                }
                ,
        ...
        , function(t, e, n) {
            ...
            e.getAsync = function(t) {
                ...
                e.setAsync = function(t, e, n) {
                    ...
                    return "number" == typeof n && (s.expiredAt = Date.now() + n),
 ...
 */
                    !function(e, n) {
                        ...
                        function m(t, e, n) {
                            e.constructor === t.constructor && n === c && e.constructor.resolve === l ? y(t, e) : n === tt ? (O(t, tt.error),
                                tt.error = null) : void 0 === n ? w(t, e) : r(n) ? v(t, e, n) : w(t, e)
                        }
                        function g(e, n) {
                                ...
                                this.promise[$] || j(this.promise),
                                    F(e) ? (this.length = e.length,
                                        ...
                                        0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0,
                                            this._enumerate(e),
                                        0 === this._remaining && w(this.promise, this._result))) : O(this.promise, x())
                            }
            ...
            !function(e) {
                ...
                n.length = 0,
                    ...
                    n.setItem = function(t, e) {
                        void 0 === e ? n.removeItem(t) : (r.hasOwnProperty(t) || n.length++,
                            r[t] = "" + e)
                    }
                    ,
        ...
        , function(t, e, n) {
            ...
            i.init = function(t) {
                ...
                var _ = f || void 0 !== a;
                if (i._setServerURLs(c({}, r(e), i._config.serverURLs, "string" == typeof a ? h(a) : a), _),
                    p)
                ...
                i._setServerURLs = function(t) {
                    ...
                    "string" != typeof t ? c(i._config.serverURLs, t) : i._config.serverURLs = h(t),
        ...
        , function(t, e, n) {
            ...
            t.exports = function(t) {
                t.GeoPoint = function(e, n) {
                    r.isArray(e) ? (t.GeoPoint._validate(e[0], e[1]),
                        this.latitude = e[0],
                        this.longitude = e[1]) : r.isObject(e) ? (t.GeoPoint._validate(e.latitude, e.longitude),
                        this.latitude = e.latitude,
                        this.longitude = e.longitude) : r.isNumber(e) && r.isNumber(n) ? (t.GeoPoint._validate(e, n),
                        this.latitude = e,
                    ...
                    this.__defineGetter__ && this.__defineSetter__ && (this._latitude = this.latitude,
                        ...
                        this.__defineSetter__("latitude", function(e) {
                            t.GeoPoint._validate(e, i.longitude),
                                i._latitude = e
                        }),
                        this.__defineSetter__("longitude", function(e) {
                            t.GeoPoint._validate(i.latitude, e),
                                i._longitude = e
                        }))
                }
                    ,
            ...
            t.exports = function(t) {
                t.ACL = function(e) {
                    ...
                    t.ACL.prototype._setAccess = function(e, n, i) {
                        ...
                        i ? this.permissionsById[n][e] = !0 : (delete s[e],
                        r.isEmpty(s) && delete this.permissionsById[n])
                    }
                    ,
                    ...
                    t.Op.Relation = t.Op._extend({
                        ...
                        toJSON: function() {
                            var t = null
                                ...
                                , s = null;
                            return this.relationsToAdd.length > 0 && (s = r.map(this.relationsToAdd, i),
                                t = {
                                    __op: "AddRelation",
                                    objects: s
                                }),
                            this.relationsToRemove.length > 0 && (s = r.map(this.relationsToRemove, i),
                                e = {
                                    __op: "RemoveRelation",
                                    objects: s
                                }),
        ...
        , function(t, e, n) {
            ...
            t.exports = function(t) {
                ...
                t.File = function(e, i, s) {
                    ...
                    r.isArray(i) && (this.attributes.metaData.size = i.length,
                        i = {
                            base64: _(i)
                        }),
                        this._extName = "",
                    ...
                    r.extend(t.File.prototype, {
                        ...
                        setACL: function(e) {
                            return e instanceof t.ACL ? (this._acl = e,
                                this) : new a(a.OTHER_CAUSE,"ACL must be a AV.ACL.")
                        },
                        name: function() {
                        ...
                        _fileToken: function(t, r) {
                            var i = this.attributes.name
                                , s = n(i);
                            !s && this._extName && (i += this._extName,
                                s = this._extName);
                            var o = e() + e() + e() + e() + e() + s
                                , a = {
                                key: o,
                            ...
                            if (!this._previousSave)
                                if (this._data) {
                                    ...
                                    this._previousSave = this._fileToken(n, e).then(function(a) {
                                        return a.mime_type && (n = a.mime_type,
                                            t.set("mime_type", n)),
                                            t._token = a.token,
            ...
            t.exports = function(t, e, n) {
                ...
                return new s(function(t, s) {
                        ...
                        o.onprogress && u.on("progress", o.onprogress),
                            u.end(function(e, r) {
                                if (r && i(r.status, r.body, r.text),
                                    e)
                                    return r && (e.statusCode = r.status,
            ...
            t.exports = function(t, e, n) {
                ...
                return new i(function(i, c) {
                        ...
                        o.onprogress && l.on("progress", o.onprogress),
                            l.end(function(t, e) {
                                if (e && s(e.status, e.body, e.text),
                                    t)
                                    return e && (t.statusCode = e.status,
                ...
                t.Object = function(e, n) {
                    ...
                    s.extend(t.Object.prototype, t.Events, {
                        ...
                        escape: function(t) {
                            ...
                            return n = h(r) ? "" : s.escape(r.toString()),
                        ...
                        _mergeMagicFields: function(e) {
                            ...
                            return t._arrayEach(r, function(r) {
                                e[r] && ("objectId" === r ? n.id = e[r] : "createdAt" !== r && "updatedAt" !== r || s.isDate(e[r]) ? n[r] = e[r] : n[r] = t._parseDate(e[r]),
                                    delete e[r])
                            }),
                                e
                        },
                        ...
                        set: function(e, n, r) {
                            ...
                            return t._arrayEach(s.keys(i), function(e) {
                                ...
                                var o = !0;
                                n instanceof t.Op.Set && s.isEqual(a.attributes[e], n.value) && (o = !1),
                                o && (delete u[e],
                        ...
                        increment: function(e, n) {
                            return (s.isUndefined(n) || s.isNull(n)) && (n = 1),
                        ...
                        fetch: function() {
                            ...
                            return c("classes", this.className, this.id, "GET", d(t), e).then(function(e) {
                                var r = n.parse(e);
                                return t.keys || n._cleanupUnsetKeys(r),
                                    n._finishFetch(r, !0),
                                    n
                            })
                        },
                        ...
                        save: function(e, n, r) {
                            ...
                            var f = this
                                , d = []
                                , p = [];
                            return t.Object._findUnsavedChildren(f, d, p),
                                d.length + p.length > 1 ? t.Object._deepSaveAsync(this, f, u) : (this._startSave(),
                                    this._saving = (this._saving || 0) + 1,
                                    this._allPreviousSaves = this._allPreviousSaves || a.resolve(),
                                    this._allPreviousSaves = this._allPreviousSaves.catch(function(t) {}).then(function() {
                                        var t = f.id ? "PUT" : "POST"
                                            , e = f._getSaveJSON()
                                            , n = {};
                                        if ((f._fetchWhenSave || u.fetchWhenSave) && (n.new = "true"),
                        ...
                        destroy: function(t) {
                            ...
                            return this.id ? (t.wait || n(),
                                c("classes", this.className, this.id, "DELETE", this._flags, t).then(function() {
                                    return t.wait && n(),
                                        e
                                })) : n()
                        },
                        ...
                        _validate: function(t, e) {
                            !e.silent && this.validate && (t = s.extend({}, this.attributes, t),
                                this.validate(t))
                        },
                        getACL: function() {
                            return this.get("ACL")
                        ...
                        ignoreHook: function(e) {
                            s.contains(["beforeSave", "afterSave", "beforeUpdate", "afterUpdate", "beforeDelete", "afterDelete"], e) || console.trace("Unsupported hookName: " + e),
                    ...
                    t.Object.destroyAll = function(t) {
                        ...
                        return c("batch", null, null, "POST", r, e).then(function(t) {
                            ...
                            if (e)
                                throw new o(e.error.code,e.error.error)
                        })
                    }
                    ,
                    ...
                    t.Object.extend = function(e, n, r) {
                        ...
                        return i.extend = function(n) {
                            ...
                            ,
                            Object.defineProperty(i, "query", Object.getOwnPropertyDescriptor(t.Object, "query")),
                            i.new = function(t, e) {
                                return new i(t,e)
                            }
                            ,
                        ...
                        return l.then(function() {
                            return a._continueWhile(function() {
                                ...
                                if (t._arrayEach(f, function(t) {
                                    ...
                                    f = n,
                                0 === e.length)
                                    return a.reject(new o(o.OTHER_CAUSE,"Tried to save a batch with a cycle."));
                ...
                t.User = t.Object.extend("_User", {
                    ...
                    _handleSaveResult: function(e) {
                        return e && !t._config.disableCurrentUser && (this._isCurrentUser = !0),
                            ...
                            this._refreshCache(),
                            !e && !this.isCurrent() || t._config.disableCurrentUser ? l.resolve() : l.resolve(t.User._saveCurrentUser(this))
                    },
                    _linkWith: function(e, n) {
                        var s, o = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, u = a.failOnNotExist, c = void 0 !== u && u;
                        return i.isString(e) ? (s = e,
                            e = t.User._authProviders[e]) : s = e.getAuthType(),
                            n ? this.save({
                                authData: r({}, s, n)
                            }, {
                    ...
                    _isLinked: function(t) {
                        var e;
                        return e = i.isString(t) ? t : t.getAuthType(),
                            !!(this.get("authData") || {})[e]
                    },
                    ...
                    _logOutWith: function(e) {
                        this.isCurrent() && (i.isString(e) && (e = t.User._authProviders[e]),
                        e && e.deauthenticate && e.deauthenticate())
                    },
                    signUp: function(t, e) {
                        var n = t && t.username || this.get("username");
                        if (!n || "" === n)
                            throw new o(o.OTHER_CAUSE,"Cannot sign up user with an empty name.");
                        var r = t && t.password || this.get("password");
                        if (!r || "" === r)
                            throw new o(o.OTHER_CAUSE,"Cannot sign up user with an empty password.");
                    ...
                    signUpOrlogInWithMobilePhone: function(t) {
                        ...
                        if (!n || "" === n)
                            throw new o(o.OTHER_CAUSE,"Cannot sign up or login user by mobilePhoneNumber with an empty mobilePhoneNumber.");
                        var r = t && t.smsCode || this.get("smsCode");
                        if (!r || "" === r)
                            throw new o(o.OTHER_CAUSE,"Cannot sign up or login user by mobilePhoneNumber  with an empty smsCode.");
                    ...
                    save: function(e, n, r) {
                        var s, o;
                        return i.isObject(e) || i.isNull(e) || i.isUndefined(e) ? (s = e,
                            o = n) : (s = {},
                            s[e] = n,
                            o = r),
                            o = o || {},
                    ...
                    logOut: function() {
                        return t._config.disableCurrentUser ? (console.warn("AV.User.current() was disabled in multi-user environment, call logOut() from user object instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"),
                            l.resolve(null)) : (null !== t.User._currentUser && (t.User._currentUser._logOutWithAll(),
                    ...
                    currentAsync: function() {
                        return t._config.disableCurrentUser ? (console.warn("AV.User.currentAsync() was disabled in multi-user environment, access user from request instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"),
                            l.resolve(null)) : t.User._currentUser ? l.resolve(t.User._currentUser) : t.User._currentUserMatchesDisk ? l.resolve(t.User._currentUser) : t.localStorage.getItemAsync(t._getAVPath(t.User._CURRENT_USER_KEY)).then(function(e) {
                            if (!e)
                                return null;
                            t.User._currentUserMatchesDisk = !0,
                    ...
                    _saveCurrentUser: function(e) {
                        var n;
                        return n = t.User._currentUser !== e ? t.User.logOut() : l.resolve(),
                            n.then(function() {
                                e._isCurrentUser = !0,
                                ...
                                return n._id = e.id,
                                    ...
                                    t.localStorage.setItemAsync(t._getAVPath(t.User._CURRENT_USER_KEY), JSON.stringify(n)).then(function() {
            ...
            t.exports = function(t) {
                t.Query = function(e) {
                    ...
                    t.Query.doCloudQuery = function(e, n, i) {
                        ...
                        return r.isArray(n) ? s.pvalues = n : i = n,
                    ...
                    r.extend(t.Query.prototype, {
                        ...
                        get: function(t, e) {
                            ...
                            var i = this.toJSON()
                                , a = {};
                            return i.keys && (a.keys = i.keys),
                            i.include && (a.include = i.include),
                            i.includeACL && (a.includeACL = i.includeACL),
                                u("classes", this.className, t, "GET", f(a), e).then(function(t) {
                                    if (r.isEmpty(t))
                        ...
                        scan: function() {
                            var t = this
                                ...
                                , c = this.toJSON();
                            i("scan %O", c),
                            c.order && (console.warn("The order of the query is ignored for Query#scan. Checkout the orderedBy option of Query#scan."),
                                delete c.order),
                            c.skip && (console.warn("The skip option of the query is ignored for Query#scan."),
                                delete c.skip),
                            c.limit && (console.warn("The limit option of the query is ignored for Query#scan."),
                                delete c.limit),
                            n && (c.scan_key = n),
                            o && (c.limit = o);
                            var l = s.resolve([])
                        ...
                        skip: function(t) {
                            return d(t, "undefined is not a valid skip value"),
                                this._skip = t,
                                this
                        },
                        limit: function(t) {
                            return d(t, "undefined is not a valid limit value"),
                                this._limit = t,
                                this
                        },
                        equalTo: function(e, n) {
                            return d(e, "undefined is not a valid key"),
                                d(n, "undefined is not a valid value"),
                                this._where[e] = t._encode(n),
                                this
                        },
                        _addCondition: function(e, n, r) {
                            return d(e, "undefined is not a valid condition key"),
                        ...
                        ascending: function(t) {
                            return d(t, "undefined is not a valid key"),
                                this._order = t,
                                this
                        },
                        ...
                        include: function(t) {
                            var e = this;
                            return d(t, "undefined is not a valid key"),
                                r.forEach(arguments, function(t) {
            ...
            (new r).__proto__ || (a = !1)),
                        ...
                        switch (l.once && this.removeListener(t, l.fn, void 0, !0),
                            ...
                            case 5:
                                return l.fn.call(l.context, e, n, r, i),
                                    !0;
                            case 6:
                                return l.fn.call(l.context, e, n, r, i, s),
                                    !0
                        }
                        for (c = 1,
                ...
                s.prototype.on = function(t, e, n) {
                    var r = new i(e,n || this)
                        , s = a ? a + t : t;
                    return this._events[s] ? this._events[s].fn ? this._events[s] = [this._events[s], r] : this._events[s].push(r) : (this._events[s] = r,
                        this._eventsCount++),
                        this
                }
                ,
                ...
                s.prototype.removeListener = function(t, e, n, i) {
                    ...
                    if (!this._events[s])
                        return this;
                    if (!e)
                        return 0 == --this._eventsCount ? this._events = new r : delete this._events[s],
                            this;
                    var o = this._events[s];
                    if (o.fn)
                        o.fn !== e || i && !o.once || n && o.context !== n || (0 == --this._eventsCount ? this._events = new r : delete this._events[s]);
                    else {
                ...
                t.Cloud = t.Cloud || {},
                    r.extend(t.Cloud, {
                        ...
                        verifySmsCode: function(t, e) {
                            ...
                            var n = {};
                            return r.isString(e) && (n.mobilePhoneNumber = e),
            ...
            t.exports = function(t) {
                ...
                t.Status = function(t, e) {
                    return this.data = {},
                        ...
                        this.query = null,
                        t && "object" === (void 0 === t ? "undefined" : r(t)) ? this.data = t : (t && (this.data.image = t),
                    ...
                    t.Status.resetUnreadCount = function(n) {
                        ...
                        return s.resolve(n || e(a)).then(function(e) {
                            ...
                            return n.inboxType = t._encode(r),
                                n.owner = t._encode(e),
                                o("subscribe/statuses/resetUnreadCount", null, null, "POST", n, a)
                        })
                    }
                    ,
                ...
                t.SearchSortBuilder = function() {
                    ...
                    t.SearchQuery = t.Query._extend({
                        ...
                        highlights: function(t) {
                            var e;
                            return e = t && r.isString(t) ? arguments : t,
                                this._highlights = e,
                                this
                        },
                        sortBy: function(t) {
        ...
        , function(t, e, n) {
            ...
            t.exports = o.Object.extend("_Conversation", {
                ...
                broadcast: function(t, e) {
                    ...
                    if (void 0 !== n.pushData && (o.push = n.pushData),
                    void 0 !== n.validTill) {
                        var u = n.validTill;
                        r.isDate(u) && (u = u.getTime()),
                            n.valid_till = u
                    }
